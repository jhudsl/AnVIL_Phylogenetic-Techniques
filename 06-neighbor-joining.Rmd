# (PART\*)  MAJOR METHODS OF TREE ESTIMATION: NEIGHBOR JOINING {-}
...
As the model test runs, R prints out most of the models being tested. For some reason, R doesn't print the basic models. The first three models listed are JC + I, JC + G (which is another way of writing JC + \Gamma$), and JC + G + I. While these models are being tested, the program is _also_ testing the basic JC model.
