...
```{r, warning=FALSE, message = FALSE}
new <- drop.tip(tree.root, c('barley_D-hordein', 'Siberian wild rye_D-hordein', 'Asiatic grass'), trim.internal = TRUE, subtree = FALSE, root.edge = 0, rooted = is.rooted(tree.root), collapse.singles = TRUE, interactive = FALSE)
...
<img src="resources/images/13-cont_output.png" title="Major point!! example image" alt="Major point!! example image" style="display: block; margin: auto;" />
...
<img src="resources/images/13-discrete_output.png" title="Major point!! example image" alt="Major point!! example image" style="display: block; margin: auto;" />
...
<img src="resources/images/13-discrete_lik_anc.png" title="Major point!! example image" alt="Major point!! example image" style="display: block; margin: auto;" />
